...
const MainListItems = (props) => {
  ...
  const [showExternalApi, setShowExternalApi] = useState(true);
        ...
        yes={() => (
          <>
            ...
            <ListItemLink
                to="/hub-notificame"
                primary="Meta"
                icon={<img src="/logo_meta.png" alt="Meta" style={{ width: 24, height: 24 }} />} // Exibe o ícone da imagem
              />
            ...
            <ListItemLink
              small
              to="/typebot" // Defina o caminho da rota para o Typebot
              primary="Typebot" // Nome exibido no menu
              icon={<img src="/logo_typebot.png" alt="Typebot" style={{ width: 24, height: 24 }} />} // Exibe o ícone da imagem
            />
            ...
            <ListItemLink
              ...
              icon={<LocalAtmIcon />}
            />
            <ListItemLink to="/messages-api" primary="API" icon={<CodeRoundedIcon/>} />
            <ListItemLink
              to="/settings"
