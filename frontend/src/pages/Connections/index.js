...
/* BOTÕES DO ÍTEM SESSÃO */

const renderActionButtons = (whatsApp) => {
  let icon = null;

  // Verifica o type e define o ícone correspondente
  if (whatsApp.type === "Instagram") {
    icon = <InstagramIcon color="disabled" />;
  } else if (whatsApp.type === "Facebook") {
    icon = <FacebookIcon color="disabled" />;
  }

  // Se houver um tipo válido, exibe o botão desativado com o ícone correspondente
  if (icon) {
    return (
      <Button size="small" variant="outlined" color="default">
		...
		/*if (whatsApp.type !== null) {
			return (
				<Button size="small" variant="outlined" color="default" disabled>
												...
												yes={() => (
													<TableCell align="center">
														<IconButton
															...
															disabled={whatsApp.type !== null} // Bloqueia se type não for null
														>
															<Edit color={whatsApp.type !== null ? "disabled" : "inherit"} />
														</IconButton>
														...
														<IconButton
															...
															disabled={whatsApp.type !== null} // Bloqueia se type não for null
														>
															<DeleteOutline color={whatsApp.type !== null ? "disabled" : "inherit"} />
														</IconButton>
													</TableCell>
												)}
											/>
