  ...
  pt: {
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          timeSendQueue: "Redirecionar para Departamento em X minutos",
          queueRedirection: "Redirecionamento de Departamento",
		  outOfHoursMessage: "Mensagem de fora de expediente",
          queueRedirectionDesc: "Selecione um Departamento para os contatos que não possuem Departamento serem redirecionados",
          prompt: "Prompt",
	...
	toasts: {
        ...
        form: {
          ...
          token: "Token",
          orderQueue: "Ordem do Departamento (Bot)",
      ...
      userModal: {
        ...
        form: {
          ...
          allTicket: "Ticket Sem Departamento [Invisível]",
      ...
      queueIntegration: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! e será removida dos departamentos e conexões vinculadas",
        },
      },
	reports: {
      ...
      queues: {
        ...
        table: {
          ...
          actions: "Ações",
          orderQueue: "Ordenação do Departamento (bot)",
        },
        buttons: {
          add: "Adicionar Departamento",
        },
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os atendimentos desse Departamento continuarão existindo, mas não terão mais nenhum Departamento atribuída.",
        },
      },
      queueSelect: {
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados do usuário serão perdidos. Os atendimento abertos deste usuário serão movidos para o Departamento.",
        },
      },
      helps: {
